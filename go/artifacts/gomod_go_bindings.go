...
const (
	GoMod_TokArrow GoModToken = 1
	GoMod_TokBracketClose GoModToken = 2
	GoMod_TokBracketOpen GoModToken = 3
	GoMod_TokComma GoModToken = 4
	GoMod_TokEOF GoModToken = 5
	GoMod_TokEquals GoModToken = 6
	GoMod_TokFloat GoModToken = 7
	GoMod_TokKWExclude GoModToken = 8
	GoMod_TokKWGo GoModToken = 9
	GoMod_TokKWGodebug GoModToken = 10
	GoMod_TokKWModule GoModToken = 11
	GoMod_TokKWReplace GoModToken = 12
	GoMod_TokKWRequire GoModToken = 13
	GoMod_TokKWRetract GoModToken = 14
	GoMod_TokKWTool GoModToken = 15
	GoMod_TokKWToolchain GoModToken = 16
	GoMod_TokLineComment GoModToken = 17
	GoMod_TokModulePath GoModToken = 18
	GoMod_TokParenClose GoModToken = 19
	GoMod_TokParenOpen GoModToken = 20
	GoMod_TokVersion GoModToken = 21
	GoMod_TokWhitespace GoModToken = 22
)
...
func (t GoModToken) String() string {
	if t == 0 || int(t) > len(GoModTokenNames) {
		return "GoModToken(" + strconv.FormatUint(uint64(t), 10) + ")"
	}
	return GoModTokenNames[t-1]
}
...
func (t GoModNode) String() string {
	if t == 0 || int(t) > len(GoModNodeNames) {
